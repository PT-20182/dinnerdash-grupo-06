...
larissa = User.create(name: 'Larissa', email: 'larissa@exemplo.com', password:'123456', password_confirmation: '123456', is_admin: true);
mariana = User.create(name: 'Mariana', email: 'mariana@exemplo.com', password:'123456', password_confirmation: '123456', is_admin: true);
gabriel = User.create(name: 'Gabriel', email: 'gabriel@exemplo.com', password:'123456', password_confirmation: '123456', is_admin: true);
# thiago = User.create(name: 'Thiago', email: 'titi@exemplo.com', password: '123456', password_confirmation: '123456', is_admin: false);
